...
showAlert = () => {
    ...
    Swal.fire({
        title: "Success",
        text: "Feedback is saved Successfully.",
                        ...
                        <Col><Card style={{ border: "1px solid black" }}>
                            <Form>
                                ...
                                <div className="text-center">
                                    ...
                                    <Button className="text-center float-center" variant="success" style={{ marginTop: "10px", marginBottom: "10px" }} type="submit" onClick={this.showAlert}>Submit
                                    </Button>
